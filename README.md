            ...
            <div class="row">
                ...
                <div class="col-lg-9 col-sm-9">
                    <nav class="mainnav">
                        ...
                        <ul>
                            <li class="has-menu-items active"><a name= "Unidad#1">Unidad#1</a><a href="README.md#Unidad#1"> Unidad#1</a></li>
                                        ...
                                        <p> Definición de IS
                                            ...
                                            <p>                                            
                                                ...
                                                <p> <strong>Ingeniería del Software</strong> <br>
                                                    ...
                                                    <img src="luis graduacion/Grafica1.png" width="800" heigth="800" alt=""><br>
               ...
               <div class="col-md-12 col-xs-12 ">
                  <div class="inside">
                     <div class="contact-info">
                        ...
                        <div class="col-md-4 col-xs-12 m-margin">
                           <h4>Email</h4>
                           <p><a href="luis.veraga@ug.edu.ec">luis.veraga@ug.edu.ec</a></p>
                        </div>
                        <div class="col-md-4 col-xs-12 m-margin">
                           <h4>Ubicación</h4>
